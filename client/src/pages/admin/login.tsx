...
import { ShieldCheck, UserCog, Lock, ArrowLeft } from "lucide-react";
...
export default function AdminLogin() {
  ...
  const handleLogin = (role: string) => {
    // In a real app we'd save the token/role context
  ...
  return (
    <div className="flex flex-col min-h-screen bg-black p-6 relative overflow-hidden">
      ...
      <button onClick={() => setLocation("/")} className="w-10 h-10 bg-zinc-900 rounded-full flex items-center justify-center border border-white/5 text-white shrink-0 mb-8 relative z-10 hover:bg-zinc-800 transition-colors">
        <ArrowLeft className="w-5 h-5" />
      </button>

      <div className="flex flex-col items-center mb-12 relative z-10">
        <div className="w-20 h-20 bg-purple-500/20 border border-purple-500/30 rounded-3xl flex items-center justify-center shadow-[0_0_40px_rgba(168,85,247,0.3)] mb-6">
